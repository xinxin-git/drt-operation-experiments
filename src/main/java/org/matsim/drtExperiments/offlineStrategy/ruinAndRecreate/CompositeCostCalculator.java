...
public class CompositeCostCalculator implements SolutionCostCalculator{
    ...
    public CompositeCostCalculator(Network network, double totalDrivingTimeShare, double totalRidingTimeShare, double totalDelayShare){
    ...
    public double calculateSolutionCost(FleetSchedules fleetSchedules, double now) {
        ...
        SolutionCostCalculator totalDelay = new TotalDelayCostCalculator(network);
